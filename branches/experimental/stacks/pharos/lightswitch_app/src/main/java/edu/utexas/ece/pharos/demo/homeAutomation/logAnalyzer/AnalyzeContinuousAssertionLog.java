 ...
 */
public class AnalyzeContinuousAssertionLog {
	 ...
	 */
	public AnalyzeContinuousAssertionLog() {

		// Read the log files...
		FilenameFilter filter = new FilenameFilter() {
		    public boolean accept(File dir, String name) {
		        return name.startsWith("LightSwitchAppContinuous") && name.contains(".log")
		        	&& !name.contains("Fail");
		    }
		};
	...
	private void computeAssertionExecCount() {
		...
		for (int i=0; i < rounds.size(); i++) {
			...
			while (e.hasMoreElements()) {
				execCounts.add((double)e.nextElement().numEvaluations);
			}
		}
		...
		System.out.println("Average assertion executions: " + df.format(avg) + " +- " + df.format(conf95)
...
//				} 
	...
	class Assertion {
		...
		public String toString() {
			return "Start Time = " + startTime + ", End Time = " + endTime 
				+ ", Duration = " + getDuration() + ", numEvaluations = " + numEvaluations;
		}
	}
	...
	public static void main(String[] args) {
		new AnalyzeContinuousAssertionLog();
	}
}

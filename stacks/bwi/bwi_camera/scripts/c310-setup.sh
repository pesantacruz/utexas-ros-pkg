...
cat $(rospack find bwi_camera)/launch/c310-template.launch | sed s/##CAMERA_NAME##/$camname/ > $(rospack find bwi_camera)/launch/$camname.launch
roslaunch bwi_camera c310-setup.launch camname:=$camname
